...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
  // This is an example of a closure. We can pass variables down, so the variable 'internal' is able to be passed down to the nestedFunction. Our inner scope references a variable created in our outer scope -- it's a one way street.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(data){
    const lowAnimals = data.map(function(item){
  ...
  */
  ...
  function lowPopulationAnimals(data){
    const fewAnimals = data.filter(function(item){
